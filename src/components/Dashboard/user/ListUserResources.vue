                ...
                <tr v-for="(i, k) in   userResourceStoreStore.DAPI_RESPONSE.response.data" :key="i._id">
                    ...
                    <td :style="{ textAlign: 'center', display: 'flex', justifyContent: 'center' }">
                      <div style="margin-right: 5%;">
                        <Buttons @click="modalStoreStore.onOnlyWtachData(i)" style="color: #ddd7d7;" :type_btn="'button'"
                        :btn_align="'center'" :btn_text="'fa-solid fa-eye'" :isIcon="true" :classApply="'BTN_PRIMARY'" />
                      </div>
                      <div style="margin-right: 5%;">
